...
**IMPORTANT: Always use the `AskUserQuestion` tool to ask clarifying questions.** Do NOT output questions as freeform text. The question tool provides structured options and better UX. Example:
...
**If unfamiliar tech involved**, use WebSearch to research:

```
WebSearch(query="[tech] best practices for [use case]")
```
